...
public func makeWhiteTexture(device: MTLDevice, label: String, descriptor: MTLTextureDescriptor) -> MTLTexture? {
    return makeColoredTexture(device: device, label: label, descriptor: descriptor, color: .white)
}

public func makeColoredTexture(device: MTLDevice, label: String, descriptor: MTLTextureDescriptor, color: Color) -> MTLTexture? {
